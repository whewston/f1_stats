...
namespace F1Stats.Core.Migrations
{
    ...
    [Migration("20260629135800_PredictionPhase")]
    partial class PredictionPhase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("F1Stats.Core.Entities.DriverStanding", b =>
                {
                    ...
                    b.HasIndex("Year", "DriverId")
                        .IsUnique();

                    b.ToTable("DriverStandings");
                });

            modelBuilder.Entity("F1Stats.Core.Entities.Prediction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Year", "Round", "DriverId", "Phase")
                        .IsUnique();

                    b.ToTable("Predictions");
                });

            modelBuilder.Entity("F1Stats.Core.Entities.QualifyingResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
